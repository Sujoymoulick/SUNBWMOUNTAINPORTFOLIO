...
/* ── Title ─────────────────────────────────────────────────────────── */
class Title {
  gl: any; plane: any; renderer: any; text: string;
  textColor: string; font: string; mesh: any;
...
/* ── Media ─────────────────────────────────────────────────────────── */
class Media {
  extra = 0; geometry: any; gl: any; image!: string; index!: number;
  length!: number; renderer: any; scene: any; screen: any; text!: string;
  viewport: any; bend!: number; textColor!: string; borderRadius!: number;
  font!: string; program: any; plane: any; title: any;
  speed = 0; isBefore = false; isAfter = false;
  width = 0; widthTotal = 0; x = 0; scale = 1; padding = 0;
...
class App {
  ...
  createMedias(items: any[], bend = 1, textColor: string, borderRadius: number, font: string) {
    const defaultItems = [
      { image: "https://picsum.photos/seed/c1/800/600", text: "AWS Cloud" },
      { image: "https://picsum.photos/seed/c2/800/600", text: "React Dev" },
      { image: "https://picsum.photos/seed/c3/800/600", text: "Node.js" },
      { image: "https://picsum.photos/seed/c4/800/600", text: "Docker" },
      { image: "https://picsum.photos/seed/c5/800/600", text: "Kubernetes" },
      { image: "https://picsum.photos/seed/c6/800/600", text: "TypeScript" },
    ];
