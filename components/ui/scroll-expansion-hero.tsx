      ...
      <section className='relative flex flex-col items-center justify-start min-h-[100dvh]'>
        <div className='relative w-full flex flex-col items-center min-h-[100dvh]'>
          ...
          <div className='container mx-auto flex flex-col items-center justify-start relative z-10'>
            <div className='flex flex-col items-center justify-center w-full h-[100dvh] relative'>
                ...
                <div className='flex flex-col items-center text-center relative z-10 mt-4 transition-none'>
                  {date && (
                    <p
                      ...
                      style={{ transform: `translateX(-${textTranslateX}vw)`, color: 'var(--primary)' }}
                    >
                      {date}
                    </p>
                  )}
              ...
              >
                <motion.h2
                  ...
                  style={{ transform: `translateX(-${textTranslateX}vw)`, color: 'var(--primary)', textShadow: '0 0 20px rgba(0,219,233,0.5)' }}
                >
                  {firstWord}
                </motion.h2>
                <motion.h2
                  className='text-4xl md:text-5xl lg:text-7xl font-bold text-center transition-none'
                  style={{ transform: `translateX(${textTranslateX}vw)`, color: 'var(--on-surface)' }}
                >
                  {restOfTitle}
                </motion.h2>
              </div>
            ...
            <motion.section
              className='flex flex-col w-full px-8 py-10 md:px-16 lg:py-20 bg-[#131314]'
              initial={{ opacity: 0 }}
